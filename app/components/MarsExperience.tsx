    ...
    <main className={`mars-shell${surfaceMode ? " surface-traverse" : ""}${spaceshipMode ? " ship-flight" : ""}${orbitalMode ? " moon-lock" : ""}${hoveredLandmark ? " landmark-hover" : ""}`}>
      ...
      {helpVisible && <aside className="help-panel" aria-label="Instrument controls and field guide">
        ...
        {orbitalMode ? <dl><div><dt>Rotate around target</dt><dd>Left / middle drag</dd></div><div><dt>Pan across target</dt><dd>Right-mouse drag</dd></div><div><dt>Change standoff</dt><dd>Mouse wheel</dd></div><div><dt>Retarget</dt><dd>Orbit highlight / menu</dd></div></dl> : (surfaceMode ? <>
          {spaceshipMode ? <>
            <dl><div><dt>Point spacecraft</dt><dd>Move mouse</dd></div><div><dt>Turn / pitch</dt><dd>A D / arrow keys</dd></div><div><dt>Thrust / reverse</dt><dd>W / S</dd></div><div><dt>Toggle cruise thrust</dt><dd>R</dd></div><div><dt>Boost + sharp turn</dt><dd>Hold Shift</dd></div><div><dt>Auto-brake + position hold</dt><dd>X</dd></div><div><dt>Roll</dt><dd>Q / E</dd></div><div><dt>Strafe</dt><dd>Z / C</dd></div><div><dt>Rise / descend</dt><dd>Space / Ctrl</dd></div><div><dt>Orbit camera</dt><dd>Left / middle drag</dd></div><div><dt>Chase to planet zoom</dt><dd>Mouse wheel</dd></div><div><dt>Stop + disembark here</dt><dd>Escape</dd></div></dl>
            <p>The assisted flight model carries momentum through every yaw and pitch so the flight path follows the hull. Shift adds a longer orange boost plume, while X brakes to a stable position hold. Flight remains independent of the orbital simulation rate.</p>
          </> : <>
