...
| Enter at a named feature | Hover, then left click | Moving over a significant Martian feature reveals its name and coordinates. Clicking it instantiates the spaceman there immediately; selected large features can use a nearby landing coordinate that gives their relief a useful human-scale view. |
